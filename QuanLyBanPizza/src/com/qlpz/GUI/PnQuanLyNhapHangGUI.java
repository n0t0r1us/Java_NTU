...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private SanPhamBLL sanPhamBUS = new SanPhamBLL();
    private NhanVienBLL nhanVienBUS = new NhanVienBLL();
    private PhieuNhapBLL phieuNhapBUS = new PhieuNhapBLL();
    private CTPhieuNhapBLL ctPhieuNhapBUS = new CTPhieuNhapBLL();
