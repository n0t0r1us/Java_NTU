package com.qlpz.GUI;

import com.qlpz.DTO.LoaiSP;
import com.qlpz.DTO.HoaDon;
import com.qlpz.DTO.SanPham;
import com.qlpz.DTO.CTHoaDon;
import com.qlpz.DTO.NhanVien;
import com.qlpz.BLL.LoaiBLL;
import com.qlpz.BLL.NhanVienBLL;
import com.qlpz.BLL.HoaDonBLL;
import com.qlpz.BLL.CTHoaDonBLL;
import com.qlpz.BLL.DangNhapBLL;
import com.qlpz.BLL.SanPhamBLL;
...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    private void loadDataComboboxLoaiBanSP() {
        ...
        ArrayList<LoaiSP> dsl = loaiBLL.getDanhSachLoai();
    ...
    private void loadDataComboboxNhanVienBan() {
        ...
        ArrayList<NhanVien> dsnv = nvBLL.getDanhSachNhanVien();
        if (dsnv != null) {
        ...
        for (int i = 0; i < cmbNhanVienBan.getItemCount(); i++) {
            ...
            if (cmbValue[0].equals(DangNhapBLL.taiKhoanLogin.getMaNhanVien() + "")) {
    ...
    private void loadDataTableSanPhamBan() {
        ...
        if (cmbLoaiSPBanHang.getItemCount() > 0) {
            ...
            if (loaiSP.equals("0")) {
                dssp = spBLL.getListSanPham();
            } else {
                dssp = spBLL.getSanPhamTheoLoai(loaiSP);
            }
        } else {
            dssp = spBLL.getListSanPham();
        }
    ...
    private void xuLyThemVaoGioHang() {
        ...
        for (int i = 0; i < tblGioHang.getRowCount(); i++) {
            ...
            if (maTbl == key) {
                ...
                spBLL.capNhatSoLuongSP(key, -soLuong);
                spBLL.docListSanPham();
                loadDataTableSanPhamBan();
                return;
            }
        }
    ...
    private void xuLyXoaSPGioHang() {
        ...
        if (row > -1) {
            ...
            spBLL.capNhatSoLuongSP(ma, soLuong);
            loadDataTableSanPhamBan();
    ...
    private void xuLyTimKiemTheoTen() {
        ...
        dtmSanPhamBan.setRowCount(0);
        ArrayList<SanPham> dssp = null;
        dssp = spBLL.getSanPhamTheoTen(ten);
    ...
    private void loadDataListHoaDon() {
        ArrayList<HoaDon> dshd = hoaDonBLL.getListHoaDon();
    ...
    private void xuLyHienCTHoaDon() {
        ...
        HoaDon hd = hoaDonBLL.getHoaDon(stMaHD[0]);
    ...
    private void loadDataTblCTHoaDon() {
        ctHDBLL.docListCTHoaDon();
        ArrayList<CTHoaDon> listCTHoaDon = ctHDBLL.getListCTHoaDon();
    ...
    private void loadDataTblCTHoaDon(String maHD) {
        ArrayList<CTHoaDon> listCTHoaDon = ctHDBLL.getListCTHoaDonTheoMaHD(maHD);
    ...
    private void xuLyClickTblCTHoaDon() {
        ...
        if (row > -1) {
            ...
            String maSP = spBLL.getSanPham("" + tblCTHoaDon.getValueAt(row, 1)).getTenSP();
    ...
    private void xuLyTimTheoKhoangNgay() {
        ArrayList<HoaDon> listHoaDon = hoaDonBLL.getListHoaDonTheoNgay(txtMinNgayLap.getText(), txtMaxNgayLap.getText());
        addDataListHoaDon(listHoaDon);
    }

    private void xuLyTimTheoKhoangGia() {
        ArrayList<HoaDon> listHoaDon = hoaDonBLL.getListHoaDonTheoGia(txtMinSearch.getText(), txtMaxSearch.getText());
        addDataListHoaDon(listHoaDon);
    }
}
