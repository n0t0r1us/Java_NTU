...
import com.qlpz.BLL.ThongKeBLL;
...
//        pnThongKeTong.add(btn_filter);
    ...
    private CategoryDataset createDataset() {
        ...
        for (int i = 1; i <= 12; i++) {
            double value = thongKeBLL.getDoanhThuThang(i, Calendar.getInstance().get(Calendar.YEAR));
    ...
    private void hienThiThongKe() {
        ThongKe thongKe = thongKeBLL.thongKe(Integer.parseInt(cmbNam.getSelectedItem() + ""));
