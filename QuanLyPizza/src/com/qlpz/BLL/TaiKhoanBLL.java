...
import com.qlpz.DAL.TaiKhoanDAL;
import com.qlpz.DTO.TaiKhoan;
...
public class TaiKhoanBLL {
    ...
    public String getTenDangNhapTheoMa(String ma) {
        ...
        return taiKhoanDAL.getTenDangNhapTheoMa(maNV);
    }

    public String getQuyenTheoMa(String ma) {
        int maNV = Integer.parseInt(ma);
        return taiKhoanDAL.getQuyenTheoMa(maNV);
    }

    public void datLaiMatKhau(String ma, String tenDangNhap) {
        int maNV = Integer.parseInt(ma);
        boolean flag = taiKhoanDAL.datLaiMatKhau(maNV, tenDangNhap);
        if (flag) {
    ...
    public void datLaiQuyen(String ma, String quyen) {
        int maNV = Integer.parseInt(ma);
        boolean flag = taiKhoanDAL.datLaiQuyen(maNV, quyen);
        if (flag) {
    ...
    public boolean kiemTraTrungTenDangNhap(String tenDangNhap) {
        return taiKhoanDAL.kiemTraTrungTenDangNhap(tenDangNhap);
    }
    ...
    public boolean themTaiKhoan(String ma, String tenDangNhap, String quyen) {
        ...
        boolean flag = taiKhoanDAL.themTaiKhoan(maNV, tenDangNhap, quyen);
        if (flag) {
    ...
    public void khoaTaiKhoan(String ma) {
        int maNV = Integer.parseInt(ma);
        boolean flag = taiKhoanDAL.khoaTaiKhoan(maNV);
        if (flag) {
    ...
    public void moKhoaTaiKhoan(String ma) {
        int maNV = Integer.parseInt(ma);
        boolean flag = taiKhoanDAL.moKhoaTaiKhoan(maNV);
        if (flag) {
    ...
    public boolean doiMatKhau(String matKhauCu, String matKhauMoi, String nhapLaiMatKhau) {
        ...
        boolean flag = taiKhoanDAL.doiMatKhau(matKhauCu, matKhauMoi);
        if (flag) {
    ...
    public int getTrangThai(String maNV) {
        ...
        return taiKhoanDAL.getTrangThai(ma);
    }
