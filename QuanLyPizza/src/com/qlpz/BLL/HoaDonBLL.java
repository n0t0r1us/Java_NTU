...
public class HoaDonBLL {
    ...
    public ArrayList<HoaDon> getListHoaDon() {
        listHoaDon = hoaDonDAL.getListHoaDon();
        return listHoaDon;
    }
    ...
    public int getMaHoaDonMoiNhat() {
        return hoaDonDAL.getMaHoaDonMoiNhat();
    }
    ...
    public ArrayList<HoaDon> getListHoaDonTheoNgay(String min, String max) {
        try {
            ...
            ArrayList<HoaDon> dshd = hoaDonDAL.getListHoaDon(dateMin, dateMax);
            return dshd;
        } catch (Exception e) {
