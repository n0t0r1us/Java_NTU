...
import com.qlpz.DAL.SanPhamDAL;
...
public class SanPhamBLL {
    ...
    public void docListSanPham() {
        listSanPham = spDAL.getListSanPham();
    }
    ...
    public String getAnh(String ma) {
        int maSP = Integer.parseInt(ma);
        return spDAL.getAnh(maSP);
    }

    public void capNhatSoLuongSP(int ma, int soLuongMat) {
        spDAL.capNhatSoLuongSP(ma, soLuongMat);
    }
