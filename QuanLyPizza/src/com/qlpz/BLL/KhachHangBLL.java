...
import com.qlpz.DAL.KhachHangDAL;
...
public class KhachHangBLL {
    ...
    public void docDanhSach() {
        this.listKhachHang = khachHangDAL.getListKhachHang();
    }
    ...
    public boolean themKhachHang(String ho, String ten, String gioiTinh) {
        ...
        kh.setTongChiTieu(0);
        boolean flag = khachHangDAL.addKhachHang(kh);
        if (flag) {
    ...
    public boolean suaKhachHang(String ma, String ho, String ten, String gioiTinh) {
        ...
        kh.setTen(ten);
        kh.setGioiTinh(gioiTinh);
        boolean flag = khachHangDAL.updateKhachHang(Integer.parseInt(ma), kh);
        if (flag) {
    ...
    public boolean xoaKhachHang(String ma) {
        ...
        try {
            ...
            if(dlg.getAction() == MyDialog.CANCEL_OPTION)
                return false;
            flag = khachHangDAL.deleteKhachHang(maKH);
        } catch (Exception e) {
