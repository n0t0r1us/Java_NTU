...
import com.qlpz.DAL.NhaCungCapDAL;
import com.qlpz.DTO.NhaCungCap;
...
public class NhaCungCapBLL {
    ...
    public void docDanhSach() {
        this.listNhaCungCap = nhaCungCapDAL.getListNhaCungCap();
    }
    ...
    public boolean themNhaCungCap(String tenNCC, String diaChi, String dienThoai) {
        ...
        boolean flag = nhaCungCapDAL.addNCC(ncc);
        if (flag) {
    ...
    public boolean suaNhaCungCap(String maNCC, String tenNCC, String diaChi, String dienThoai) {
        ...
        boolean flag = nhaCungCapDAL.updateNCC(ncc);
